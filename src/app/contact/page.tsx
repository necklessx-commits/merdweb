    ...
    return (
        <main>
            ...
            <div className="flex flex-1 w-full flex-col items-center justify-center text-center py-[8.5rem]">
                <form onSubmit={handleSubmit} className="relative w-full max-w-lg items-center justify-center p-10 rounded-md boder-1 border-white border-opacity-5 space-y-3">
                    <div>
                    ...
                    <div>
                        <textarea
                            ...
                            className="h-24 px-5 pr-10 w-full rounded-lg text-base focus:outline-none border border-foreground/5 resize-none"
                            required
                        />
                    </div>
                    <div className="pt-7">
                        <button type="submit" className="justify-center item-center rounded-md w-full h-12 bg-secondary text-black border border-foreground/5">
